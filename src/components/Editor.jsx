    ...
    overflow-hidden `}
      ...
      <div className="flex flex-row w-[100%] h-[30px] p-[.5rem]">
        <span className="w-[10px] h-[10px] bg-[#dadada]
            rounded-full mr-1 trans hover:bg-[#FF7068]"></span>
        <span className="w-[10px] h-[10px] bg-[#dadada]
            rounded-full mr-1 trans hover:bg-[#FFC443]"></span>
        <span className="w-[10px] h-[10px] bg-[#dadada]
            rounded-full trans hover:bg-[#3DCF53]"></span>
      ...
      <div className="w-[100%] h-[100%] bg-[#23272E] p-[1rem]">
        <p className={`${visible ? 'typewriter' : ''} whitespace-nowrap
            font-[600] text-[16px] font-mono w-[26ch] [--pasos:26]
            [--delay-typing:0s]`}>
          <span className="text-[#B771CD]">import
        ...
        <p className={`${visible ? 'typewriter' : ''} whitespace-nowrap
          ...
          <span className="text-[#989EAB]">{">"}</span>
          <br />
          <span className="text-[#989EAB] ml-[5rem]">html</span><br />
          <span className="text-[#989EAB] ml-[5rem]">css</span><br />
          <span className="text-[#989EAB] ml-[5rem]">javascript</span><br />
          <span className="text-[#989EAB] ml-[5rem]">php</span><br />
          <span className="text-[#989EAB] ml-[5rem]">React</span><br />
          <span className="text-[#989EAB] ml-[5rem]">Tailwindcss</span><br />
